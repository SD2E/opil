...
class TestOpil(unittest.TestCase):
    ...
    def test_visitor(self):
        ...
        # Define a visitor class to test
        class Visitor:

            def visit_protocolinterface(self, p):
                p.description = 'Visited'

            def visit_parameter(self, p):
                p.description = 'Visited'
        ...
        protocol.has_parameter = [param]
        protocol.measurement_type = [measurement_type]
        doc.add(protocol)

        self.assertIsNone(protocol.description)
        self.assertIsNone(param.description)
        self.assertIsNone(measurement_type.description)

        v = Visitor()
        protocol.accept(v)
        param.accept(v)
        self.assertEqual(protocol.description, 'Visited')
        self.assertEqual(param.description, 'Visited')
        self.assertIsNone(measurement_type.description)
